 ...
 */
class CRM_Chcustomwebform_Upgrader_Base {

  /**
   * @var CRM_Chcustomwebform_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Chcustomwebform_Upgrader(
        'chcustomwebform',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Chcustomwebform_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Chcustomwebform_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
